...
#define LED_PIN     5        // GPIO pin connected to DATA line of the strip
#define NUM_LEDS    60       // total LEDs on your strip
...
const CRGB C_BLUE    = CRGB(24,  95,  165); // P1  #185FA5
const CRGB C_GREEN   = CRGB(59,  109, 17);  // P2  #3B6D11
const CRGB C_RED     = CRGB(226, 75,  74);  // overlap / victory  #E24B4A
const CRGB C_RED_DIM = CRGB(50,  15,  15);  // dim state for blink
